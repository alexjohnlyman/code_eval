...
#
# Write a program which reconstructs each sentence out of a set of words and prints out the original sentences.
#
...
# The tricky part is going to be finding the missing number and assigning that to the last word


def data_recovery(file):
    with open(file, 'r+') as f:
        for line in f:
            print line
            line1, order = line.split(';')
            print line1.split()
            print order.split()

data_recovery("data_recovery.txt")
